...
import '/components/no_badge_component/no_badge_component_widget.dart';
...
class BadgePageWidget extends StatefulWidget {
  const BadgePageWidget({super.key});
                            ...
                            builder: (context) =>
                              ...
                              builder: (context, snapshot) {
                                ...
                                List<ZiskOceneniRecord>
                                    ...
                                    snapshot.data!;
                                if (listViewZiskOceneniRecordList.isEmpty) {
                                  return const NoBadgeComponentWidget();
                                }
